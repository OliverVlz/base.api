...
export class CustomersController {
  ...
  async exportCustomersToExcel(@Res() res: Response, @Query() query: GetCustomerDto) {
    const customers = await this.queryBus.execute(new GetCustomersQuery(query));
    await this.excelExportService.exportCustomersToExcel(customers, res);
  }
